...
from crews.dr_raimundo.crew_dr_raimundo import build_crew_drraimundo, sanitizar_links as sanitizar_links_drraimundo
...
def executar_crew_drraimundo(tema: str = Query(...), palavra_chave: str = Query(...)):
    ...
    resultado.raw = sanitizar_links_drraimundo(resultado.raw)
    return JSONResponse(content=resultado.model_dump())
